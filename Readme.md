...
# Parsing + Configuration Script – VS133 - Rev. A

This **Parsing + Configuration** script is designed for the **VS133** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – VS133 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **VS133** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).

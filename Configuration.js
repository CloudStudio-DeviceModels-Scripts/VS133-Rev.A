...
function getEndpoints(deviceAddress, endpoints) {
    ...
    var e = endpoints.addEndpoint("1", "People Counter 1 IN", endpointType.genericSensor);
    e.variableTypeId = 1301;
    var e = endpoints.addEndpoint("2", "People Counter 1 OUT", endpointType.genericSensor);
    e.variableTypeId = 1301;
    var e = endpoints.addEndpoint("3", "People Counter 2 IN", endpointType.genericSensor);
    e.variableTypeId = 1301;    
    var e = endpoints.addEndpoint("4", "People Counter 2 OUT", endpointType.genericSensor);
    e.variableTypeId = 1301;
    var e = endpoints.addEndpoint("5", "People Counter 3 IN", endpointType.genericSensor);
    e.variableTypeId = 1301;    
    var e = endpoints.addEndpoint("6", "People Counter 3 OUT", endpointType.genericSensor);
    e.variableTypeId = 1301;
    var e = endpoints.addEndpoint("7", "People Counter 4 IN", endpointType.genericSensor);
    e.variableTypeId = 1301;
    var e = endpoints.addEndpoint("8", "People Counter 4 OUT", endpointType.genericSensor);
    e.variableTypeId = 1301;
